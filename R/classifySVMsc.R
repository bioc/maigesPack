...
classifySVMsc <- function(obj=NULL, sLabelID="Classification",
...
nGenes=3, cliques=100) {
    ...
    oneMoreIter <- function(tab, idxAnt, cliques) {
    ...
    for(i in 1:(nGenes-1)) {
        classCliques <- oneMoreIter(table, tmp, cliques)
    ...
    Date=date(), method=paste("Support Vector Machinne class searchng the best",
