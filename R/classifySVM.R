...
##             facToClass -> named list with 2 character vectors specifying the
##                           samples to be compared. If NULL the first 2 types
##                           of SlabelID are used
...
classifySVM <- function(obj=NULL, sLabelID="Classification", facToClass=NULL,
gNameID="GeneName", geneGrp=1, path=NULL, nGenes=3) {
    ...
    oneMoreIter <- function(tab, idxAnt) {
    ...
    Date=date(), method="Support Vector Machinne, exaustive method", V.info=vInfo)
